    ...
    public class Visuals
    {
        ...
        public static void Map(Island? urhere)
        {
            ...
            Console.WriteLine(@"|               _|/\|_              -------  --\                   ------  --/      -                                    /-    -\     \-        -\       -\    |");
                ...
                if (Sp2 == "[YOU]") Game.Text(Sp2, 0, ConsoleColor.Yellow); else Game.Text(Sp2, 0);
                Console.WriteLine(@"   --             --  -\        --                      -\                               |-        -      \         -        -   |");
            Console.WriteLine(@"|               |\/\/|        --/                     --   --/                          -                     ------   |         |      |+- ___--+|        |   |");
            Console.WriteLine(@"|              \|/\/\|   .''`/:                                                           --\        -- -----/         |         |      || (0 0) ||        |   |");
            Console.WriteLine(@"|      :\''.    \`'. |  ||  /  :                                                             --   --/                  |         |      ||  |||  ||        |   |");
                Console.Write(@"|      : \ ||   |\ |||  || /    o                                   ---\                                       ");
                if (Sp4 == "[YOU]") Game.Text(Sp4, 0, ConsoleColor.Yellow); else Game.Text(Sp4, 0);
                Console.WriteLine(@"   |  -/\-   |      |+-------+|        |   |");
            ...
            Console.WriteLine(@"|               -                                               - --\                               ---     --                                                 |");
                Console.Write(@"|                \            ");
                if (Sp3 == "[YOU]") Game.Text(Sp3, 0, ConsoleColor.Yellow); else Game.Text(Sp3, 0);
                Console.Write(@"                                 ----\           ");
                if (Sp1 == "[YOU]") Game.Text(Sp1, 0, ConsoleColor.Yellow); else Game.Text(Sp1, 0);
                Console.WriteLine(@"      -----/      /                                        O          |");
            Console.WriteLine(@"|                  _,.---.---.---.--.._                                   ----\          ----/           -                                                     |");
            Console.WriteLine(@"|              _.-' `--.`---.`---'-. _,`--.._                    /-            ---------/                          O                                  O        |");
                Console.Write(@"|             /`--._ .'.     `.     `,`-.`-._\                  -                                       |                                 ");
                if (Sp5 == "[YOU]") Game.Text(Sp5, 0, ConsoleColor.Yellow); else Game.Text(Sp5, 0);
                Console.WriteLine(@"                |");
