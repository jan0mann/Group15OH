...
namespace OperationHav
{
    public class IslandPlastic : Island
    {
        ...
        {
            Game.Text("\nThis island is closest to the Asian mainland, making it a collecting point for huge quantities of plastic waste…", 4);
            ...
            Game.Text("\nIn the recent history of this insular republic, two parties have been fighting for the balance of power:", 4);
            Game.Text("\nThe corporations ", 1, ConsoleColor.Yellow);
            Game.Text("and the ", 0);
            Game.Text("environmentalists.", 1, ConsoleColor.Green);
            Game.Text("\nCorporations operate under the name 'Industrial Association'. Their goals are to make money, the health of the ecosystem is not in their agenda.", 5, ConsoleColor.Yellow);
            Game.Text("\nTheir view on the environmentalists is, that they are a group of fearmongerers that are overreacting on the small damage done and that the ecosystem will eventually fix itself.", 6);
            ...
            Game.Text("\nThose people hate the corporations with all their heart. They think they are blinded by their greediness and that their goals are futile, since no one takes their wealth to their grave.", 6);
        ...
        public static void Story_Minigame()
        {
            ...
            while (i < 5)
            {
                if (i == 0)
                {
                    Game.Text("\n\n\nYou have been invited for an interview at the biggest broadcasting channel on the island", 4);
                    ...
                    if (answer == "admit")
                    {
                        ...
                        Game.Text("\nFun Fact: this is incorrect, because fish, seabirds, sea turtles, and marine mammals can become entangled in or ingest plastic debris, causing suffocation, starvation, and drowning ", 6);
                    ...
                    else if (answer == "advise")
                    {
                        ...
                        Game.Text("\n\nYou advise that plastic can be very harmful if used thoughtlessly. The industry must limit the production of plastic and search for alternatives.", 5);
                        Game.Text("\nFun Fact: your advise is correct, because fish, seabirds, sea turtles, and marine mammals can become entangled in or ingest plastic debris, causing suffocation, starvation, and drowning ", 6);
                        Game.Text("\nFun fact: Some alternatives can be: bamboo straws, bags made of fabric or even fishing nets made from micro-algae, making them biodegradable.\n", 5);
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        Console.WriteLine(corporations.ToString());
                        Console.ForegroundColor = ConsoleColor.Green;
                ...
                if (i == 1)
                {
                    ...
                    Game.Text("\nYou think about talking to them and", 2);
                    Game.Text("\nteach ", 0, ConsoleColor.Green);
                    Game.Text("them about responsibility by picking up their trash together. But you could just .", 3);
                    ...
                    {
                        corporations.Influence++;
                        Game.Text("\n\nYou ignore your consciousness, sunbathing was too pleasant to abandon. The beach stays littered and the teenagers will probably do it again.", 5);
                        Game.Text("\nFun Fact: Seas and oceans belong to all of us, they are part of the earth which is our home. It should be our responsibility to keep them clean and healthy.\n", 5);
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        Console.WriteLine(corporations.ToString());
                        Console.ForegroundColor = ConsoleColor.Green;
                ...
                if (i == 2)
                {
                    ...
                    Game.Text("\n\n\nYou are at the supermarket and go to the cashier counter to pay for the items.", 3);
                    ...
                    Game.Text("\nYou know him as a representative of the plastic bottle company in ... island. He tells the woman that you are free to chose and that environmentalists' fake news must not influence your decision.", 6);
                    Game.Text("\nYou stop a think for a bit.", 2);
                    Game.Text("\nWill you ", 1);
                    Game.Text("\nbuy ", 0, ConsoleColor.Yellow);
                    Game.Text("the bottles ", 1);
                    Game.Text("\nor search for an ", 0);
                    ...
                    {
                        corporations.Influence++;
                        Game.Text("\nYou tell the woman that you are an adult and your desicions are your own.The man congratulates you, he will spread the word of your actions. The woman remains disappointed.", 5);
                        Game.Text("\nFun Fact: Plastic bottles can accumulate in sensitive coastal ecosystems and coral reefs.", 3);
                        Game.Text("\nOver time, plastic bottles break down into smaller particles, releasing harmful chemicals into the water", 4);
                    ...
                    {
                        environmentalists.Influence++;
                        Game.Text("\nYou tell the man that facts say otherwise. Plastic bottles can indeed pose a serious threat to our seas. The woman congratulates you, she will spread the word of your actions. The man tried to suppress his anger.", 6);
                        Game.Text("\nFun Fact: Plastic bottles can accumulate in sensitive coastal ecosystems and coral reefs.", 3);
                        Game.Text("\nOver time, plastic bottles break down into smaller particles, releasing harmful chemicals into the water", 4);
                        Game.Text("\nBetter alternatives to plastic bottles are: glass bottles, stainless steel bottles, aluminum bottles. They can be used for long periods of time.\n", 4);
                        Console.ForegroundColor = ConsoleColor.Yellow;
                ...
                if (i == 3)
                {
                    ...
                    Game.Text("\nThe next day begins with loud voices out of your window. ", 2);
                    ...
                    Game.Text("them. Their demands are noble.", 1);
                    Game.Text("\nAnother course of action would be to ", 1);
                    ...
                    {
                        environmentalists.Influence++;
                        Game.Text("\nSeeing you join them, the already outraged crowd gets more fervorous.", 3);
                        ...
                        Game.Text("\nFun Fact: Politicians are more likely to act on an issue, if a well-prepared and a passionate crowd demands a solution.", 4);
                    ...
                    {
                        corporations.Influence++;
                        Game.Text("\nSo much struggle for such a topic seems unfounded to you.", 3);
                ...
                if (i == 4)
                {
                    ...
                    Game.Text("\nThe mysterious teacher you have met when you first visited Såndiægø has proposed that you help raise awareness about water platic pollution at the school he is teaching. ", 5);
                    ...
                    {
                        corporations.Influence++;
                        Game.Text("\nYou came unprepared and you deliver a boring presentation. ", 2);
                    ...
                    {
                        environmentalists.Influence++;
                        Game.Text("\nThe students look very motivated with this new way of teaching. This can also encourage them to learn on their own. ", 4);
                        Game.Text("\nA couple of days later, a student group delivers a small game with choices, where the player learns even by making the wrong decisions. They have implemented information such as: ", 5);
                        Game.Text("\nFun Fact 1: ocean plastic pollution is on track to triple by 2060. ", 2);
                        Game.Text("\nFun Fact 2: the thing about plastic is that it never truly goes away, it just breaks down into smaller and smaller pieces called microplastics.", 4);
